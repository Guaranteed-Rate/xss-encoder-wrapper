...
;;  repo in GitHub. (I did find several Javadoc mistakes in their Encode class though.)
;;
  ...
  (testing "for-html-attribute ..."
    (testing "calls that return empty string"
      (testing "for-html-attribute with nil and empty string..."
        (is (= (for-html-attribute "") ""))
        (is (= (for-html-attribute nil) ""))))
    (testing "Other tests..."
  ...
  (testing "for-html-unquoted-attribute ..."
    (testing "calls that return empty string"
      (testing "for-html-unquoted-attribute with nil and empty string..."
        ...
        (is (= (for-html-unquoted-attribute nil) ""))))
    (testing "Other tests..."
      (is (= (for-html-unquoted-attribute " ") "&#32;"))
...
;; Using same test as 'for-html' since Javadoc for Encode.forXml(String) refers to Encode.forHtml(String)
